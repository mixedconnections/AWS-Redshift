...
# - Edit the file `dwh.cfg` in the same directory as this file
# [AWS]<BR>
# KEY= YOUR_AWS_KEY<BR>
...
def prettyRedshiftProps(props):
    ...
    keysToShow = ["ClusterIdentifier", "NodeType", "ClusterStatus", "MasterUsername", "MasterUserPassword", "DBName", "Endpoint", "NumberOfNodes", 'VpcId'] 
